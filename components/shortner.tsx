function Shortner() {
  return (
    <div className="mb-[88px] py-2 px-6  maxw">
      <div className=" -mt-20 sm:-mt-14 p-6 bg-Primary-DarkViolet bg-[url('/bg-shorten-mobile.svg')] bg-no-repeat bg-right-top rounded-xl flex flex-col sm:flex-row gap-4">
        <input
